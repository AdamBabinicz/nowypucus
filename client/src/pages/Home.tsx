        ...
        <div className="container py-16 lg:py-24 relative z-10">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="/oferta" className="inline-block bg-white text-primary-600 dark:bg-sky-500 dark:text-white font-semibold py-3 px-6 rounded-lg shadow-lg hover:bg-gray-100 dark:hover:bg-sky-600 transition-colors duration-300">
                {t("hero.seeServices")}
              </Link>
